...
app.include_router(mipp_challenges_router, prefix=api_prefix)
app.include_router(mipp_startups_router, prefix=api_prefix)
app.include_router(mipp_matching_router, prefix=api_prefix)
app.include_router(mipp_evaluations_router, prefix=api_prefix)
app.include_router(mipp_pilots_router, prefix=api_prefix)
app.include_router(mipp_evidence_router, prefix=api_prefix)
app.include_router(mipp_scale_router, prefix=api_prefix)
app.include_router(mipp_ml_router, prefix=api_prefix)
