    ...
    <div className="ui-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      <div>
        ...
        <div style={{ fontSize: '0.8rem', color: '#64748B', marginBottom: '1rem' }}>
          Target Districts: <strong style={{ color: '#0B2545' }}>{(Array.isArray(challenge.targetDistricts) ? challenge.targetDistricts : [challenge.targetDistricts || 'To be confirmed']).join(', ')}</strong>
        </div>
