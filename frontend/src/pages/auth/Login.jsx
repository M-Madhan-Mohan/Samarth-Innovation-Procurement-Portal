...
const Login = ({ currentUser, onRoleChange }) => {
  ...
  const handleRoleSelect = (roleKey) => {
    ...
    if (roleKey === 'startup') {
      setEmail('contact@agrivision.in');
    }

    if (roleKey === 'government') {
      setEmail('dept.innovation@maharashtra.gov.in');
    }

    if (roleKey === 'evaluator') {
      setEmail('sk.mahajan@evaluators.mahabridge.gov.in');
    }
  };
      ...
      >
        <div
          style={{
            ...
            padding: '2.5rem',
            boxShadow: '0 12px 32px rgba(11, 37, 69, 0.1)',
          }}
        >
          {/* Login Header */}
          <div
